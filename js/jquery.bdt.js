...
(function ($) {
	...
	$.fn.bdt = function (options, callback) {
		...
		return this.each(function () {
			...
			arrowDown = settings.sort.arrowDown;
			arrowUp = settings.sort.arrowUp;
			searchPlaceholder = settings.searchPlaceholder;
			multi = settings.sort.multi;
			...
			obj
				...
				.each(function () {
					...
					th.click(function () {
						...
						} else if ($(this).find('.sort-icon').hasClass(arrowUp)) {
							if (multi) {
								$(this).find('.sort-icon').removeClass(arrowDown);
								$(this).find('.sort-icon').removeClass(arrowUp);
							} else {
								$(this)
									.find('.sort-icon')
									.removeClass(arrowUp)
						...
						oldIndex = thIndex;
						paginate(tableBody, $(".pagination .active a").text());
					});
